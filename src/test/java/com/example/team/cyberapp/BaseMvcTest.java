...
import com.example.team.cyberapp.auth.impl.UserDaoImpl;
import com.example.team.cyberapp.config.ApplicationConfig;
import com.example.team.cyberapp.config.SecurityConfig;
...
@ComponentScan(basePackages = "com.example.team.cyberapp.auth", basePackageClasses = SecurityConfig.class, excludeFilters = {
